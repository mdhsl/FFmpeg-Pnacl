...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=pnacl --disable-runtime-cpudetect --prefix=/home/nevro/softs/nacl_sdk/pepper_56/toolchain/linux_pnacl/le32-nacl/usr --cross-prefix=pnacl- --cc=pnacl-clang --ld=pnacl-clang++ --pkg_config=pkg-config --enable-gpl --enable-static --disable-shared --enable-incompatible-libav-abi --enable-cross-compile --disable-ffplay --enable-ffprobe --disable-ffserver --disable-asm --disable-inline-asm --disable-indevs --disable-protocols --disable-network --disable-protocol=file --disable-demuxer=rtsp --disable-demuxer=image2 --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-network --extra-libs='-lppapi_simple -lppapi -lppapi_cpp -lnacl_io' --enable-libx264 --disable-libx265 --disable-libvpx --enable-avformat --enable-avdevice --enable-avfilter --enable-swresample --disable-pthreads --enable-avcodec --enable-avutil --enable-decoder=h264
prefix=/home/nevro/softs/nacl_sdk/pepper_56/toolchain/linux_pnacl/le32-nacl/usr
...
CC_IDENT=clang version 3.7.0 (https://chromium.googlesource.com/a/native_client/pnacl-clang.git ce163fdd0f16b4481e5cf77a16d45e9b4dc8300e) (https://chromium.googlesource.com/a/native_client/pnacl-llvm.git 83991f993fea6cd9c515df12c3270ab9c0746215) nacl-version=f7d719122cd7c2fe3ebc52e7c0b011c583bf3e9c
ARCH=c
INTRINSICS=none
CC=pnacl-clang
CXX=pnacl-g++
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=-I/home/nevro/softs/nacl_sdk/pepper_56/include -I/home/nevro/softs/nacl_sdk/pepper_56/include/ppapi_simple -I/home/nevro/softs/nacl_sdk/pepper_56/toolchain/include -I/home/nevro/softs/nacl_sdk/pepper_56/toolchain/toolchain/linux_pnacl/le32-nacl/usr/include -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__
CFLAGS=   -std=c99 -fomit-frame-pointer -I/home/nevro/nas/DATA/EXT-nas/nacl_sdk/pepper_56/toolchain/linux_pnacl/le32-nacl/usr/include -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
LD_PATH=-L
DLLTOOL=
WINDRES=pnacl-windres
DEPWINDRES=pnacl-clang
DOXYGEN=doxygen
LDFLAGS=-L/home/nevro/softs/nacl_sdk/pepper_56/lib/pnacl/Release -L/home/nevro/softs/nacl_sdk/pepper_56/toolchain/linux_pnacl/le32-nacl/usr/lib  -Wl,--as-needed -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-L/home/nevro/nas/DATA/EXT-nas/nacl_sdk/pepper_56/toolchain/linux_pnacl/le32-nacl/usr/lib -lx264 -lpthread -lm -lm -lppapi_simple -lppapi -lppapi_cpp -lnacl_io 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
